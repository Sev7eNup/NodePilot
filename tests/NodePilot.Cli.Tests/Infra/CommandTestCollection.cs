...
/// no test class get a disable-parallelization marker via this fixture-less stub; command
/// integration tests and direct <c>Console.SetOut</c> tests opt in via
/// <c>[Collection(CommandTestCollection.Name)]</c>.
/// </summary>
