...
const queryClient = new QueryClient({
  // Surfaces failed queries the way mutations have always surfaced theirs. Policy and its
  // reasoning live in lib/queryErrorToast so they can be tested directly.
