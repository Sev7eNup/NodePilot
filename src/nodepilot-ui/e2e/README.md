...
| 80.10–80.11 | Global chat widget — request/draft continuation across navigation and expansion, unread reply, retry, designer-panel coordination, mobile focus and viewport sizing, seven-skin screenshots | `ai-chat-widget.spec.ts` |
