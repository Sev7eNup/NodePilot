...
/// <summary>
/// One execution-family alert collector run by <see cref="NotificationDispatcher"/> every pass for
/// CUSTOM
/// rules (terminal executions, long-running, queued-long). Infra/signal alerts are no longer
/// collectors —
