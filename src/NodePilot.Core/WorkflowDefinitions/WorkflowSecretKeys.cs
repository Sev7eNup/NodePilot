...
public static class WorkflowSecretKeys
{
    ...
    /// (<see cref="WorkflowSecretContent.CredentialHeaderNames"/>).
    /// </summary>
    ...
    /// (<see cref="WorkflowSecretContent.LooksSecret"/>). Content detection covers secrets that
    /// hide
