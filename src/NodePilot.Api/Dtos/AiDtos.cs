...
/// <summary>One AI-related audit entry for a workflow (workflow-scoped, used by the panel's
...
/// badges).
/// <see cref="Llm"/> is the raw "LLM usable" signal (kill-switch on + active profile resolves)
/// independent
/// of the AiKnowledge master switch — the SPA gates every AI entry point's visibility on it
/// (designer
/// assistant, script-editor generate, AI workflow generation), while <see cref="Enabled"/> keeps
/// gating
