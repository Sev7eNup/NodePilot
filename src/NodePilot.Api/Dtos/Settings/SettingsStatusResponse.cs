...
/// </summary>
/// <param name="OverridesPath">Absolute filesystem path to the active runtime-overrides
/// file.</param>
/// <param name="RestartRequired">True when at least one section has been saved that is not yet
/// active.</param>
/// <param name="RestartRequiredSince">UTC instant of the oldest unactivated save. Null when nothing
/// is pending.</param>
/// <param name="RestartRequiredFor">List of section paths (e.g. <c>"Smtp"</c>,
/// <c>"Authentication:Ldap"</c>) waiting on a restart.</param>
