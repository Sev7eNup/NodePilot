...
public record CreateGlobalVariableRequest(string Name, string Value, [property: JsonRequired] bool IsSecret, string? Description, Guid? FolderId)
{
...
public record UpdateGlobalVariableRequest(string Name, string? Value, [property: JsonRequired] bool IsSecret, string? Description, Guid? FolderId)
{
    public override string ToString()
...
public record MoveGlobalVariableRequest([property: JsonRequired] Guid FolderId);
