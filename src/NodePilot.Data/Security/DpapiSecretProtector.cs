...
/// <summary>
/// Default <see cref="ISecretProtector"/> backed by Windows DPAPI. <see
/// cref="DataProtectionScope"/>
/// drives the user-vs-machine binding semantics. <c>CurrentUser</c> is the dev default,
/// <c>LocalMachine</c> is the operator-deployment recommendation.
/// <para>
/// DPAPI-encrypted blobs are <b>machine-bound</b> regardless of scope. Any cluster deployment
/// that needs cross-host portability must switch the registered protector to
