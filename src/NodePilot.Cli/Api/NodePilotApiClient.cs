...
public sealed class NodePilotApiClient
{
    ...
    public async Task<OperationsGraphResponse> GetOperationsGraphAsync(CancellationToken ct, int windowMinutes = 30)
    {
    ...
    // Response plumbing is shared with the MCP client — see ApiResponseReader in Core.
