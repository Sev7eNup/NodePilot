...
Schreibfehler darf die Mutation **nie** abbrechen.
...
| Credential | `CREDENTIAL_CREATED\|UPDATED\|DELETED` |
...
| Execution | `EXECUTION_STARTED\|CANCELLED\|RETRIED` |
...
| Import/Export | `WORKFLOW_EXPORTED\|EXPORTED_BULK\|IMPORTED\|IMPORTED_SCORCH` |
...
| Custom Activities | `CUSTOM_ACTIVITY_CREATED\|UPDATED\|DELETED\|IMPORTED\|ROLLED_BACK` |
...
Admin-only, Cursor-Pagination, Export als CSV/NDJSON (`GET /api/audit/export?format=csv|ndjson`).
