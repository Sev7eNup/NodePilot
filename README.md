...
src/
  ...
  NodePilot.ServiceSwitcher/  WPF utility for exclusive local NodePilot/SCOrch service control
...
tests/
  ...
  NodePilot.ServiceSwitcher.Tests/  xUnit — discovery, state machine, fail-closed switching
...
- **[docs/service-switcher.md](docs/service-switcher.md)** — local NodePilot/System Center engine switcher behavior and safety model.
