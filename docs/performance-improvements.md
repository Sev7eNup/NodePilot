...
| Datei | Änderung |
|---|---|
| [`SubWorkflowLimiter.cs`](../src/NodePilot.Engine/Activities/InMemorySubWorkflowGate.cs) (neu) | Statische Klasse mit `Semaphore = new SemaphoreSlim(128, 128)`. Single Source of Truth für die engine-weite Sub-Workflow-Concurrency-Cap. |
